...
# Results
The system demonstrates that Golay processing generally achieves lower Root Mean Square Error (RMSE) at lower SNR levels compared to Zadoff-Chu, showing higher robustness in extremely noisy environments. A sharp drop in estimation error is observed around -40 dB to -38 dB, where the target signal becomes distinguishable from noise. These can be found in detail in the report.
